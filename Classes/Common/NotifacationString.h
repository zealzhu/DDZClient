#pragma once
#ifndef _NOTIFACATION_STRING_H
#define _NOTIFACATION_STRING_H

#include <string>

const std::string strUpdateRoomList = "UPDATE_ROOM_LIST";
const std::string strPlayerEnterInRoom = "PLAYER_ENTER_IN_ROOM";
const std::string strPlayerReady = "PLAYER_PLAYER_READY";
const std::string strAllPlayerReady = "ALL_PLAYER_READY";
